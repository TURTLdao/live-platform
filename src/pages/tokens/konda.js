...
export default function Page({ konda_price }) {
  ...
  const [kondaPrice, setKondaPrice] = useState(0);
  const [kondaVolume, setKondaVolume] = useState(0);
  ...
  } = KondaInformation(kondaPrice, kondaVolume);
    ...
    >
      <Container maxWidth="xl" >
        ...
        >
          ...
          <Grid xs={12} sm={6} lg={3} >
            <PriceCard sx={{ height: '100%', marginRight: '10px' }} lastPrice={formatted_volume} cardTitle={'$KONDA Volume'}/>
          </Grid>
