function TurtleInformation(turtle_price, turtle_volume) {
    // String tools
    ...
    const raw_volume = Number(turtle_volume).toFixed(2);
    ...
    const formatted_volume = formatter.format(raw_volume);
